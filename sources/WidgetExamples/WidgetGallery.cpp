...
WidgetGallery::WidgetGallery(QWidget* parent)
        :QDialog(parent), progressBar(createProgressBar())
{
...
QTabWidget* WidgetGallery::createItemViewTabWidget()
{
    ...
    listModel->appendRow(
            new QStandardItem(QIcon(QLatin1String(":/qt-project.org/styles/commonstyle/images/diropen-128.png")),
                    tr("Directory")));
    listModel->appendRow(
            new QStandardItem(QIcon(QLatin1String(":/qt-project.org/styles/commonstyle/images/computer-32.png")),
                    tr("Computer")));
